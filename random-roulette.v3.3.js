/* Random Roulette modular build · 2026-08-25T02:02:57.151Z */
...
(function installGameRegistry(global) {
  ...
  function refreshCards() {
    document.querySelectorAll('#luckGameGrid .game-launch[data-game]').forEach((button) => {
    ...
    document.querySelectorAll('#luckGameGrid .physical-game-item').forEach((button) => {
