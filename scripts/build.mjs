...
await Promise.all([
  ...
  writeFile(path.join(root, 'random-roulette.v3.12.js'), appJs, 'utf8'),
  writeFile(path.join(root, 'random-roulette.v3.12.css'), appCss, 'utf8'),
...
console.log(`빌드 완료: dist + v3.12 배포 번들 + 호환 루트 번들`)
